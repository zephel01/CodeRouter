...
最終更新: 2026-04-20
作成者: zephel01
状態: **v0.5.1 Closeout Pack 完了** (2026-04-20) — A-1 `capability-degraded` の TypedDict 化 / A-2 `scripts/verify_v0_5.sh` への streaming D-scenario 追加 / A-3 `chain-uniform-auth-failure` warn (401/403 uniform non-retryable 時の probable-misconfig hint)。計 243 tests green (+18)、`capability-degraded` は型付き single choke-point 経由、verify runner は 4 scenario (3 gate + streaming dedup) をカバー。
