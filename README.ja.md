...
**次の予定**（v1.0 は [plan.md §10](./plan.md)、v1.0+ は §18）: v1.1 — CI 向け `coderouter doctor --network` とランチャースクリプト。v1.5 — メトリクスダッシュボード。
...
- v1.1 — `coderouter doctor --network` (CI 用の明示的ネット許可ラン)、ランチャー
- v1.5 — メトリクスダッシュボード
